...
def main(name):
    ...
    length_seconds,sampling_rate=1000, 150 #that makes 1500 pts
    ...
    xtrain,ytrain, xtest, ytest=get_data(backcast_length, forecast_length,limit, '{}.csv'.format(name),10)
    ...
    #model training
    model.fit(xtrain, ytrain, validation_data=(xtest,ytest), epochs=10000, batch_size=128)
